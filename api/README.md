...
This is the backend API for DeepV-Ki, providing smart code analysis and AI-powered documentation generation.
...
DeepV-Ki supports multiple LLM providers. The environment variables above are required depending on which providers you want to use:
...
##### Configuration Files
DeepV-Ki now uses JSON configuration files to manage various system components instead of hardcoded values:
